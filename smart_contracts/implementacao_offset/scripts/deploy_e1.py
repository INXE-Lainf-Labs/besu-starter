...
def parse_args() -> argparse.Namespace:
    ...
    default_contract = (script_dir.parent / "contract" / "CarbonCreditNFT_E1.sol").resolve()
    ...
    parser.add_argument("--contract-file", default=str(default_contract), help="Arquivo .sol")
    parser.add_argument("--contract-name", default="CarbonCreditNFT_E1", help="Nome do contrato no arquivo")
